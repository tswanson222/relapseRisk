...
```{r table7, echo = FALSE, message = FALSE, warning = FALSE,out.width = "950px",fig.height=8}
  questionTable(data = params$participant, week=as.numeric(params$epoch), questions=params$questions,
                participant_assignment = params$participant_assignment,table_number = 4)


``` 

```{r table8, echo = FALSE, message = FALSE, warning = FALSE,out.width = "950px",fig.height=8}
  questionTable(data = params$participant, week=as.numeric(params$epoch), questions=params$questions,
                participant_assignment = params$participant_assignment,table_number = 5)
